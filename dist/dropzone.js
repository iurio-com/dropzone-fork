var $6mU8w$swchelperscjs_call_supercjs = require("@swc/helpers/cjs/_call_super.cjs");
var $6mU8w$swchelperscjs_class_call_checkcjs = require("@swc/helpers/cjs/_class_call_check.cjs");
var $6mU8w$swchelperscjs_create_classcjs = require("@swc/helpers/cjs/_create_class.cjs");
var $6mU8w$swchelperscjs_inheritscjs = require("@swc/helpers/cjs/_inherits.cjs");
var $6mU8w$swchelperscjs_object_spreadcjs = require("@swc/helpers/cjs/_object_spread.cjs");
var $6mU8w$swchelperscjs_object_spread_propscjs = require("@swc/helpers/cjs/_object_spread_props.cjs");
var $6mU8w$swchelperscjs_possible_constructor_returncjs = require("@swc/helpers/cjs/_possible_constructor_return.cjs");
...
var $b1d17cfb1d15c36a$export$2e2bcd8739ae039 = /*#__PURE__*/ function() {
    "use strict";
    function Emitter() {
        (0, $6mU8w$swchelperscjs_class_call_checkcjs._)(this, Emitter);
    }
    (0, $6mU8w$swchelperscjs_create_classcjs._)(Emitter, [
        {
    ...
    addedfile: function(file) {
        ...
        if (this.previewsContainer && !this.options.disablePreviews) {
            ...
            var removeFileEvent = function(e) {
                e.preventDefault();
                e.stopPropagation();
                if (file.status === (0, $a601ff30f483e917$export$2e2bcd8739ae039).UPLOADING) {
                    if (_this.options.dictCancelUploadConfirmation) return (0, $a601ff30f483e917$export$2e2bcd8739ae039).confirm(_this.options.dictCancelUploadConfirmation, function() {
...
var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ function(Emitter1) {
    "use strict";
    (0, $6mU8w$swchelperscjs_inheritscjs._)(Dropzone, Emitter1);
    function Dropzone(el, options) {
        (0, $6mU8w$swchelperscjs_class_call_checkcjs._)(this, Dropzone);
        var _this;
        _this = (0, $6mU8w$swchelperscjs_call_supercjs._)(this, Dropzone);
        var fallback, left;
        _this.element = el;
        ...
        _this.options = Object.assign({}, (0, $b657c03155fc27e2$export$2e2bcd8739ae039), elementOptions, options != null ? options : {});
        _this.options.previewTemplate = _this.options.previewTemplate.replace(/\n*/g, "");
        // If the browser failed, just call the fallback and leave
        if (_this.options.forceFallback || !Dropzone.isBrowserSupported()) return (0, $6mU8w$swchelperscjs_possible_constructor_returncjs._)(_this, _this.options.fallback.call(_this));
    ...
    (0, $6mU8w$swchelperscjs_create_classcjs._)(Dropzone, [
        {
        ...
        },
        {
            ...
            value: function _renameFile(file) {
                var cleanFile = (0, $6mU8w$swchelperscjs_object_spread_propscjs._)((0, $6mU8w$swchelperscjs_object_spreadcjs._)({}, file), {
                ...
                if (this.options.binaryBody) {
                    ...
                    if (this.options.params) {
                        ...
                        for(var key in additionalParams){
                            ...
                            // individually.
                            for(var i1 = 0; i1 < value.length; i1++)formData.append(key, value[i1]);
                    ...
                    for(var i2 = 0; i2 < dataBlocks.length; i2++){
                        var dataBlock = dataBlocks[i2];
...
$a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement = function(element) {
    ...
    if (element.getAttribute("id") && typeof $a601ff30f483e917$export$2e2bcd8739ae039.options !== 'undefined') return $a601ff30f483e917$export$2e2bcd8739ae039.options[$a601ff30f483e917$var$camelize(element.getAttribute("id"))];
